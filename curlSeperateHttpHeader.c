...
// gcc -o curlSeperateHttpHeader curlSeperateHttpHeader.c -lcurl
int main(void)
{
  CURL *curl_handle;
  ...
  printf("%s, headerfile handle %p\n", __FUNCTION__, headerfile);
  ...
  printf("%s, bodyfile handle %p\n", __FUNCTION__, bodyfile);
